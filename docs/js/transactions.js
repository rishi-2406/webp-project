...
const TransactionsCtrl = (function (StorageCtrl, UICtrl) {
  ...
  const updateTransactionList = function () {
    ...
    for (let i = startIndex; i < endIndex; i++) {
      ...
      row.innerHTML = `
                ...
                <td><span class="transaction-category">${
                  transaction.category
                }</span></td>
                <td class="transaction-amount ${amountClass}">${amountPrefix} ₹${formatCurrency(
        transaction.amount
      )}</td>
                <td>
  ...
  const updateSummary = function () {
    ...
    document.getElementById("summary-balance").textContent = `₹${formatCurrency(
      balance
    )}`;
  };
  ...
  const setupEventListeners = function () {
    ...
    document
      ...
      .addEventListener("click", hideTransactionModal);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const settings = StorageCtrl.getSettings() || {};
